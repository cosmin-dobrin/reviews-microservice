...
public class Review {
    ...
    @JoinColumn(name = "accommodation_id", foreignKey = @ForeignKey(name = "FK_review_accommodation"))
    ...
    public Review(int stars, String comment, LocalDate timestamp, Accommodation accommodation, User user) {
        this.stars = stars;
